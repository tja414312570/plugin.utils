 ...
 * 作为{@link com.yanan.utils.reflect.AppClassLoader}的底层,为其提供访问Class文件缓存
...
public class ClassHelper {
	...
	public static ClassHelper getClassHelper(String requestClass) throws ClassNotFoundException {
		return ClassInfoCache.getClassHelper(Class.forName(requestClass));
	}
	...
	public Method getMethod(int hashKey) {
		return this.methodMap.get(hashKey);
	}
}
